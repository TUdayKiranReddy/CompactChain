...
bool NIPoE_Verify(const std::vector<flint::BigInt>& set, ThreadPool& threadPool, const RSAKey& rsaKey, 
							PrimeRepGenerator& repGen, flint::BigMod& u, const flint::BigMod& w, flint::BigMod& Q);
...
void accumulateSet(const std::vector<flint::BigInt>& reps, const RSAKey::PublicKey& publicKey,
                   flint::BigMod& accumulator, flint::BigInt& product);
