...
private:
    ...
    friend void xgcd(const BigInt& f, const BigInt& g, BigInt& a, BigInt& b, BigInt& d);
    friend void bezout_coefficients(const BigInt& f, const BigInt& g, BigInt& a, BigInt& b);
};
...
/** GCD Operation */
void xgcd(const BigInt& f, const BigInt& g, BigInt& a, BigInt& b, BigInt& d);

void bezout_coefficients(const BigInt& f, const BigInt& g, BigInt& a, BigInt& b);
}  //end namespace flint
